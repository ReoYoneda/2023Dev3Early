    ...
    <div class="container">
        ...
        <div class="row py-2 justify-content-center"><!-- ヘッダー用コンテナ -->
            ...
            <div class="col-sm-10 col-md-8 col-lg-7 col-xl-6"><!-- ヘッダー用のコンテナサイズ -->
                ...
                <!-- 見出し -->
                <div class="row">
                    <div class="header-title" title="投稿を閉じたいときは [Close] を押してください">
                        回答一覧
                    </div>
                </div>
                <!--/見出し -->
            ...
            <div class="col-11 col-lg-10 col-xl-9"><!-- 用のコンテナサイズ -->
                ...
                <div class="row mb
                    ...
                    <div class="col-4 col-md-3">
                        ...
                        <div>
                        <input type="button" class="black" onclick="location.href='G1-6-1-3.php?postID=<?php echo $_GET['postID'] ?>'" value="Close">
                        </div>
                    </div>
                ...
                <div class="row tdiv">
                    ...
                    <div class="td col-9" style="white-space: nowrap; overflow: auto; white-space: pre; max-height: 100vh;">
                        '.$reply["reply_text"].'
                    </div>
                </div>';
                }
