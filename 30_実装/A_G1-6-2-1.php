...
<input type="button" onclick="location.href='A_G1-6-1-1.php'" value=" Open " style="background-color: #fff;">
<input type="button" onclick="location.href='A_G1-6-2-1.php'" value="Closed" style="background-color: #dfdfdf;">
...
<?php
    ...
    foreach($posts as $post){
        ...
        $postID = $post["post_id"];
        echo
        '<div onclick="location.href='."'A_G1-6-2-2.php?postID=".$postID."'".'" method="POST">
        ----------------------------------------------------------------------------<br>'.
