    ...
    <div class="container" style="min-width: 450px;"><!-- コンテナ　ディスプレイ幅360px以下の画面ではレイアウト比率を固定にする -->
        ...
        <div class="row py-2 justify-content-center"><!-- ヘッダー用コンテナ -->
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5"><!-- ヘッダー用のコンテナサイズ -->
                ...
                <!-- ナビ -->
                <div class="row nav">
                    <a class="col" href="A_G1-4-1.php" title="みんなの投稿"><i class="bi bi-house-door"></i></a>
                    <a class="col" href="A_G1-6-1-1.php" title="じぶんの投稿"><i class="bi bi-person-lines-fill"></i></i></a>
                    <a class="col" href="A_G1-7.php" title="ランキング"><i class="bi bi-trophy"></i></a>
                    <a class="col" href="A_G1-8.php" title="開催イベント"><i class="bi bi-flag"></i></a>
                    <a class="col" href="A_G1-9-1.php" title="ステータス"><i class="bi bi-person-circle"></i></a>
