    ...
    <div class="container">
        ...
        <div class="row py-2 justify-content-center"><!-- ヘッダー用コンテナ -->
            ...
            <div class="col-sm-10 col-md-8 col-lg-7 col-xl-6"><!-- ヘッダー用のコンテナサイズ -->
                ...
                <!-- 見出し -->
                <div class="row">
                    <div class="header-title" title="閉じた投稿の一覧です">
                        じぶんの投稿
                    </div>
                </div>
                <!--/見出し -->
            ...
            <div class="col-11 col-lg-10 col-xl-9"><!-- 用のコンテナサイズ -->
                ...
                <div class="row mb
                    ...
                    <div class="col-4 col-md-3">
                        ...
                        <div>
                            <input type="button" value="Open" onclick="location.href='G1-6-1-1.php'">
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-md-3">
                        ...
                        <div>
                        <input type="button" value="Closed" onclick="location.href='G1-6-2-1.php'" style="outline: 4px solid #74f;">
                        </div>
                    </div>
