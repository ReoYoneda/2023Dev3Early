INSERT INTO `evaluation`(`evaluation_trp`,
                         `evaluation_receuvednum`,
                         `evaluation_receivedvalue`,
                         `evaluation_sentnum`,
                         `evaluation_sentvalue`) 
                VALUES  (   100, 10,  30, 10,  50),
                        (   200, 20,  70, 20,  90),
                        (   400, 30, 110, 30, 130),
                        (   800, 40, 150, 40, 160),
                        (  1600, 50, 200, 50, 180);
...
INSERT INTO `replies`   (`post_id`,
                ...
                VALUES  (1,
                        ...
                        石のひっくり返し: 石を置いた後、その石によって相手の石をひっくり返す必要があるかどうかをチェックします。指定した位置に石を置いた後、8方向（上下左右および4つの斜め方向）に対して、隣接する相手の石があるかどうかを確認します。隣接する相手の石の列または行が、自分の石で挟まれている場合、その間の相手の石を自分の石にひっくり返します。
...
INSERT INTO `events`    (`event_start`,
                         ...
                         `event_title`,
                         `event_content`)
                VALUES  ('2023-10-15-00-00-00',
                         '2023-10-30-23-59-59',
                         '対中間考査　スペシャル企画',
                         '＜個人戦＞期間中は獲得RPが２倍に増加！！期間終了時にレートが「S-」以上のユーザーにバッジを授与！')